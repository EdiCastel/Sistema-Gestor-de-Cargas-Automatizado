...
?>
  <head>
    ...
    <title>Dar de baja Mercancia</title>
  </head>
  <body>
  <div class="container">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <h1>Dar de baja mercancia</h1><br>
  <?php
    if(isset($_GET['registrar'])){
      $id = $_GET['id'];
      $res = $conexion->query("delete from mercancia WHERE id_mercancia='$id';");
    ?>
        <div class="alert alert-success" role="alert">
        <h4 class="alert-heading">Registro completo!</h4>
        <p>Los datos de la mercancia han sido borrados de la base de datos</p>
        </div>
        <?php
    }
  ?> 
    ...
    ?>  
      ...
      <div class="row">
        <div class="form-group col">
          <a class="w-100 btn btn-lg btn-primary" href="BajaMercancia.php" role="button">Atras</a>
        </div>
        <div class="form-group col">
