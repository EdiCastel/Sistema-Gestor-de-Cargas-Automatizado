...
<html lang="en">
  ...
  <body>
    ...
    <h1>Menu Mercancia</h1><br>
    <p>Elige la opcion que deseas</p><br>
    <div class="container">
      <div class="row">
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="actualizarMercancia.php" role="button">Actualizar Mercancia</a>
        </div>
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="BajaMercancia.php" role="button">Dar de Baja Mercancia</a>
        </div>
      </div><br>
      <div class="row">
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="ConsultarMercancia.php" role="button">Consultar Datos de Mercancia</a>
        </div>
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="NuevaMercancia.php" role="button">Nueva Mercancia</a>
        </div>
      </div><br>
      <div class="row">
          <div class="col">
