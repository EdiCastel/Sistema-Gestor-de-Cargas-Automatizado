...
?>
  <head>
    ...
    <title>Consultar Mercancia</title>
  </head>
  <body>
  <div class="container">  
      ...
      <h1>Consultar datos de la mercancia</h1><br>
      <p>Ingrese el nombre de la mercancia que desea buscar</p>
      <form class="fregisttro" id="fregistro" action="consultarDatosMercancia.php" method="get">
      <div class="row">
