...
?>
  <head>
    ...
    <title>Consultar Datos De Mercancia</title>
  </head>
  <body>
  <div class="container">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <h1>Consultar Datos De Mercancia</h1><br>
        <?php
        ...
        if (is_null($res)) {
          echo ("El campo nombre está vacío"); 
            ...
            while($var_fila=$res->fetch_array()){
                ?>  
                <h3>Datos encontrados de la mercancia</h3>
    ...
    ?>  
      ...
      <div class="row">
        <div class="form-group col">
          <a class="w-100 btn btn-lg btn-primary" href="consultarMercancia.php" role="button">Atras</a>
        </div>
        <div class="form-group col">
