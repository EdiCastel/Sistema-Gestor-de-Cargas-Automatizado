...
?>
  <head>
    ...
    <title>Dar de baja Chofer</title>
  </head>
  <body>
  <div class="container">
  ...
  <?php
    ...
    ?>
        ...
        <p>Los datos del chofer han sido borrados de la base de datos</p>
        </div>
        <?php
    }
  ?> 
    ...
    ?>  
      ...
      <div class="row">
        <div class="form-group col">
          <a class="w-100 btn btn-lg btn-primary" href="bajaChofer.php" role="button">Atras</a>
        </div>
        <div class="form-group col">
