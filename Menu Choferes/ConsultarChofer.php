...
?>
  ...
  <div class="container">  
      ...
      <p>Ingrese el nombre del chofer que desea buscar</p>
      <form class="fregisttro" id="fregistro" action="ConsultarDatosChofer.php" method="get">
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="form-group col">
        <a class="w-100 btn btn-lg btn-primary" href="menuchoferes.php" role="button">Atras</a>
        </div>
        <div class="form-group col">
        </div>
      </div>
