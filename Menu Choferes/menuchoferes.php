...
<html lang="en">
  ...
  <body>
    ...
    <h1>Menu Choferes</h1><br>
    <p>Elige la opcion que deseas</p><br>
    
    <div class="container">
      <div class="row">
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="Actualizarchofer.php" role="button">Actualizar Chofer</a>
        </div>
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="bajaChofer.php" role="button">Dar de Baja Chofer</a>
        </div>
      </div><br>
      <div class="row">
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="consultarChofer.php" role="button">Consultar Datos de Chofer</a>
        </div>
        <div class="col">
