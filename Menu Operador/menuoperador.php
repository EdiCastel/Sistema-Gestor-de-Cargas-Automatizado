...
?>
  ...
  <body>
    ...
    <h1>Menu Operador</h1><br>
    <p>Elige la opcion que deseas</p><br>
    
    <div class="container">
      <div class="row">
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="actualizarOperador.php" role="button">Actualizar Operador</a>
        </div>
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="bajaOperador.php" role="button">Dar de Baja Operador</a>
        </div>
      </div><br>
      <div class="row">
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="consultarOperador.php" role="button">Consultar Datos del Operador</a>
        </div>
        <div class="col">
