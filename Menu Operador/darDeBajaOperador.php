...
?>
  <head>
    ...
    <title>Dar de baja Operador</title>
  </head>
  <body>
  <div class="container">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <h1>Dar de baja operador</h1><br>
  <?php
    if(isset($_GET['registrar'])){
      $id = $_GET['id'];
      $res = $conexion->query("delete from usuario WHERE id_usuario='$id';");
    ?>
        <div class="alert alert-success" role="alert">
        <h4 class="alert-heading">Registro completo!</h4>
        <p>Los datos del operador han sido borrados de la base de datos</p>
        </div>
        <?php
    }
  ?> 
    ...
    ?>  
      ...
      <div class="row">
        <div class="form-group col">
          <a class="w-100 btn btn-lg btn-primary" href="bajaOperador.php" role="button">Atras</a>
        </div>
        <div class="form-group col">
