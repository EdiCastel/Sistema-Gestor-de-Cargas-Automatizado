...
?>
  ...
  <div class="container">  
      ...
      <h1>Dar de baja datos de operador</h1><br>
      <p>Ingrese el nombre del operador que desea buscar</p>
      <form class="fregisttro" id="fregistro" action="darDeBajaOperador.php" method="get">
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="form-group col">
        <a class="w-100 btn btn-lg btn-primary" href="menuoperador.php" role="button">Atras</a>
        </div>
        <div class="form-group col">
        </div>
      </div>
