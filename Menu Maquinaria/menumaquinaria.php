...
<html lang="en">
  <head>
    ...
    <title>Menu de Maquinaria</title>
  </head>
  <body>
    <div class="container">
    ...
    <h1>Menu Maquinaria</h1><br>
    <p>Elige la opcion que deseas</p><br>
    <div class="container">
      <div class="row">
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="ActualizarMaquinaria.php" role="button">Actualizar Maquinaria</a>
        </div>
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="bajaMaquinaria.php" role="button">Dar de Baja Maquinaria</a>
        </div>
      </div><br>
      <div class="row">
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="ConsultarMaquinaria.php" role="button">Consultar Datos de Maquinaria</a>
        </div>
        <div class="col">
          <a class="w-100 btn btn-lg btn-primary" href="NuevaMaquinaria.php" role="button">Nueva Maquinaria</a>
        </div>
      </div><br>
      <div class="row">
          <div class="col">
