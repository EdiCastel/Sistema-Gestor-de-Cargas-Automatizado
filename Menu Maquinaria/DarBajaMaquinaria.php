...
?>
  <head>
    ...
    <title>Dar de baja Maquinaria</title>
  </head>
  <body>
  <div class="container">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <h1>Dar de baja maquinaria</h1><br>
  <?php
    if(isset($_GET['registrar'])){
      $id = $_GET['id'];
      $res = $conexion->query("delete from maquinaria WHERE id_maquinaria='$id';");
    ?>
        <div class="alert alert-success" role="alert">
        <h4 class="alert-heading">Registro completo!</h4>
        <p>Los datos de la maquinaria han sido borrados de la base de datos</p>
        </div>
        <?php
    }
  ?> 
    ...
    ?>  
      ...
      <div class="row">
        <div class="form-group col">
          <a class="w-100 btn btn-lg btn-primary" href="bajaMaquinaria.php" role="button">Atras</a>
        </div>
        <div class="form-group col">
