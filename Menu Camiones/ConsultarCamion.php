...
?>
  ...
  <div class="container">  
      ...
      <h1>Consultar datos de Camion</h1><br>
      <p>Ingrese las placas del camion que desea buscar</p>
      <form class="fregisttro" id="fregistro" action="ConsultarDatosCamion.php" method="get">
      <div class="row">
