...
?>
  <head>
    ...
    <title>Consultar Datos De Camion</title>
  </head>
  <body>
  <div class="container">
        ...
        if (is_null($res)) {
          echo ("El campo nombre está vacío"); 
            ...
            while($var_fila=$res->fetch_array()){
                ?>  
                <h3>Datos encontrados del camion</h3>
    ...
    ?>  
      ...
      <div class="row">
        <div class="form-group col">
          <a class="w-100 btn btn-lg btn-primary" href="ConsultarCamion.php" role="button">Atras</a>
        </div>
        <div class="form-group col">
