...
?>
  <head>
    ...
    <title>Ingresar Nuevo Camion</title>
  </head>
  <body>
  <div class="container">
  ...
  <?php
    if(isset($_GET['registrar'])){
      ...
      $res = $conexion->query("insert into camion values(NULL, '$marca','$modelo', '$placas', '$capacidad')");
    ?>
        <div class="alert alert-success" role="alert">
        <h4 class="alert-heading">Registro completo!</h4>
        <p>Los datos del nuevo camion han sido ingresados en la base de datos</p>
        </div>
        <?php
    }
  ?> 
     <div class="py-5 text-center">
       <h1>Ingresar un nuevo camion</h1>
     </div>
      ...
      <div class="row">
        <div class="form-group col">
          <a class="w-100 btn btn-lg btn-primary" href="menucamiones.php" role="button">Atras</a>
        </div>
        <div class="form-group col">
