...
?>
  <head>
    ...
    <title>Actualizar Datos De Camion</title>
  </head>
  <body>
  <div class="container">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <h1>Actualizar Datos De camion</h1><br>
  <?php
    if(isset($_GET['registrar'])){
      ...
      $res = $conexion->query("UPDATE camion SET id_camion=id_camion, marca='$marca', modelo='$modelo', placas='$placas', capacidad='$capacidad' WHERE  id_camion='$id';");
    ?>
        <div class="alert alert-success" role="alert">
        <h4 class="alert-heading">Registro completo!</h4>
        <p>Los datos del camion han sido actualizados en la base de datos</p>
        </div>
        <?php
    }
  ?> 
    ...
    ?>  
      ...
      <div class="row">
        <div class="form-group col">
          <a class="w-100 btn btn-lg btn-primary" href="ActualizarCamion.php" role="button">Atras</a>
        </div>
        <div class="form-group col">
