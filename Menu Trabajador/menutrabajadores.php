...
?>
  <head>
    ...
    <title>Menu de Trabajadores</title>
  </head>
  <body>
    <div class="container">
    ...
    <h1>Menu Trabajador</h1><br>
    <p>Elige la opcion que deseas</p><br>
    
    <div class="container">
      <div class="row">
        <div class="col">
            <a class="w-100 btn btn-lg btn-primary" href="registrarTrabajador.php" role="button">Nuevo Trabajador</a>
        </div>
        <div class="col">
            <a class="w-100 btn btn-lg btn-primary" href="consultarTrabajador.php" role="button">Consultar Datos de Trabajador</a>
        </div>
      </div><br>
      <div class="row">
        <div class="col">
